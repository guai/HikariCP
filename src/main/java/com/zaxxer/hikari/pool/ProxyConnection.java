...
public abstract class ProxyConnection implements Connection
{
   ...
   public IProxyFactory getProxyFactory() {
      return poolEntry.getProxyFactory();
   }
   ...
   {
      return getProxyFactory().getProxyStatement(this, trackStatement(delegate.createStatement()));
   }
   ...
   {
      return getProxyFactory().getProxyStatement(this, trackStatement(delegate.createStatement(resultSetType, concurrency)));
   }
   ...
   {
      return getProxyFactory().getProxyStatement(this, trackStatement(delegate.createStatement(resultSetType, concurrency, holdability)));
   }
   ...
   {
      return getProxyFactory().getProxyCallableStatement(this, trackStatement(delegate.prepareCall(sql)));
   }
   ...
   {
      return getProxyFactory().getProxyCallableStatement(this, trackStatement(delegate.prepareCall(sql, resultSetType, concurrency)));
   }
   ...
   {
      return getProxyFactory().getProxyCallableStatement(this, trackStatement(delegate.prepareCall(sql, resultSetType, concurrency, holdability)));
   }
   ...
   {
      return getProxyFactory().getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql)));
   }
   ...
   {
      return getProxyFactory().getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, autoGeneratedKeys)));
   }
   ...
   {
      return getProxyFactory().getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, resultSetType, concurrency)));
   }
   ...
   {
      return getProxyFactory().getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, resultSetType, concurrency, holdability)));
   }
   ...
   {
      return getProxyFactory().getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, columnIndexes)));
   }
   ...
   {
      return getProxyFactory().getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, columnNames)));
   }
