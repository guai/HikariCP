...
public class TestValidation
{
   ...
   public void validateValidCustomizer()
   {
      try {
         HikariConfig config = new HikariConfig();
         config.setDataSourceClassName("ru.programpark.hikari.mocks.StubDataSource");
         config.setConnectionCustomizerClassName("ru.programpark.hikari.TestValidation$TestCustomizer");
         config.validate();
   ...
   public void validateMissingUrl()
   {
      try {
         HikariConfig config = new HikariConfig();
         config.setDriverClassName("ru.programpark.hikari.mocks.StubDriver");
         config.validate();
         Assert.fail();
      }
