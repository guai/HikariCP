...
import ru.programpark.hikari.mocks.StubConnection;
import ru.programpark.hikari.mocks.StubStatement;
 ...
 *    "ru.programpark.hikari.JavaProxyFactory"
 *    "ru.programpark.hikari.CglibProxyFactory"
 *    "ru.programpark.hikari.JavassistProxyFactory"
 *
...
public class TestConnections
{
   ...
   public void testCreate() throws SQLException
   {
      ...
      config.setDataSourceClassName("ru.programpark.hikari.mocks.StubDataSource");
   ...
   public void testMaxLifetime() throws Exception
   {
      ...
      System.setProperty("ru.programpark.hikari.housekeeping.periodMs", "100");

      HikariDataSource ds = new HikariDataSource(config);

      try {
         System.clearProperty("ru.programpark.hikari.housekeeping.periodMs");
         ...
         ds.close();
         System.getProperties().remove("ru.programpark.hikari.housekeeping.periodMs");
      }
   }
